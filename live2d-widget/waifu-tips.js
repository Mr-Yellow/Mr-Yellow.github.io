...
function loadWidget(config) {
	...
	let userAction = false,
		userActionTimer,
		messageTimer,
		messageArray = ["好久不见，甚是想念", "大坏蛋！你都多久没理人家了呀，嘤嘤嘤～", "嗨～快来陪我玩吧！", "拿小拳拳锤主人胸口！", "记得把人家加入 Adblock 白名单哦！"];
	...
	(function registerEventListener() {
		...
		devtools.toString = () => {
			showMessage("哈哈，主人打开了控制台，是想要看看我的小秘密吗？", 6000, 9);
		};
		window.addEventListener("copy", () => {
			showMessage("复制了些什么呀小傻瓜，转载要记得加上出处哦！", 6000, 9);
		});
		window.addEventListener("visibilitychange", () => {
			if (!document.hidden) showMessage("哇，主人终于回来了～", 6000, 9);
		});
	})();
	...
	(function welcomeMessage() {
		...
		if (location.pathname === "/") { // 如果是主页
			...
			else text = "主人是夜猫子呀？这么晚还不睡觉，明天起的来嘛？";
